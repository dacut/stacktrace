...
func TestMessage(t *testing.T) {
	...
	expected := strings.Join([]string{
		"so closed",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:51 (doClosure.func1) ---",
		"Caused by: pointedly",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:46 (ptrObj.doPtr) ---",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:42 (privateObj.doPrivate) ---",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:38 (privateObj.DoPublic) ---",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:34 (PublicObj.doPrivate) ---",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:30 (PublicObj.DoPublic) ---",
		"Caused by: failed to start doing",
		" --- at github.com/dacut/stacktrace/functions_for_test.go:26 (startDoing) ---",
	}, "\n")
